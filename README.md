...
~~Multilingual model support will come in a future update to the bot.~~ **Multilingual models are already supported with the bot, just set the voice ID of the model in question. If it doesnt work, let me know.**

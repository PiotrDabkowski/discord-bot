...
class AddVoiceModal(miru.Modal):
    ...
    labels = miru.TextInput(label="Leave alone for default labels.", placeholder=None, style=hikari.TextInputStyle.SHORT, required=True, max_length=30, value='{"accent": "American"}')
